...
/// The `InterruptibleChatWithAnalyzer` class is responsible for handling continuous speech recognition.
/// It uses the new SpeechAnalyzer from iOS 26
...
public class InterruptibleChatWithAnalyzer: InterruptibleChatProtocol, @unchecked Sendable {
  ...
  private var speechRecognizer: VoiceChatbotRecognizer
  ...
  private func restartRecognition() {
    Task { @MainActor in
      ...
      speechRecognizer = VoiceChatbotRecognizer()
